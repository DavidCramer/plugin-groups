...
class Plugin_Groups_Settings extends Plugin_Groups {
	...
	public function check_exporter() {
		$beta = filter_input( INPUT_GET, 'activate-beta', FILTER_SANITIZE_STRING );
		if( $beta ){
			require_once ABSPATH . 'wp-admin/includes/plugin.php';
			activate_plugin( PLORG_BETA );
			deactivate_plugins( PLORG_PLUGIN);
			wp_safe_redirect( self_admin_url( 'plugins.php?page=plugin-groups' ) );
			exit;
		}
	...
	public function prepare_filter_addons( $plugins ) {
		...
		unset( $plugins['plugin-groups/plugin-groups.php'] );
		return $plugins;
	}
	...
	public function create_admin_page() {
		...
		include PLORG_PATH . 'legacy/includes/edit.php';
