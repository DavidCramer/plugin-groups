...
class Plugin_Groups {
	...
	public function replace_scripts( $scripts ) {
		...
		$assets_url = PLORG_URL . '/legacy/assets/js/';
	...
	public function enqueue_admin_stylescripts() {
		...
		if ( self::is_plugin_group_screen() ) {
			...
			wp_enqueue_style( 'plugin_groups-core-style', PLORG_URL . 'legacy/assets/css/styles.css' );
			wp_enqueue_style( 'plugin_groups-baldrick-modals', PLORG_URL . 'legacy/assets/css/modals.css' );
			wp_enqueue_script( 'plugin_groups-wp-baldrick', PLORG_URL . 'legacy/assets/js/wp-baldrick-full.js', array( 'jquery' ), false, true );
			wp_enqueue_script( 'jquery-ui-autocomplete' );
			wp_enqueue_script( 'jquery-ui-sortable' );
			wp_enqueue_script( 'plugin_groups-core-script', PLORG_URL . 'legacy/assets/js/scripts.js', array( 'plugin_groups-wp-baldrick' ), false );
			wp_enqueue_style( 'wp-color-picker' );
			wp_enqueue_script( 'wp-color-picker' );
			wp_enqueue_style( 'plugin_groups-select2-style', PLORG_URL . 'legacy/assets/css/select2.css' );
			wp_enqueue_script( 'plugin_groups-select2-script', PLORG_URL . 'legacy/assets/js/select2.min.js', array( 'jquery' ), false, true );
		}
